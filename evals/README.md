# CodinIT Evaluation System

This directory contains the evaluation system for benchmarking CodinIT against various coding evaluation frameworks.

## Overview

The CodinIT Evaluation System allows you to:

1. Run CodinIT against standardized coding benchmarks
...
- Node.js 16+
- VSCode with CodinIT extension installed
- Git

### Activation Mechanism

The evaluation system uses an `evals.env` file approach to activate test mode in the CodinIT extension. When an evaluation is run:

1. The CLI creates an `evals.env` file in the workspace directory
2. The CodinIT extension activates due to the `workspaceContains:evals.env` activation event
