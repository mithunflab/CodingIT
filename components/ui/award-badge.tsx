...
export const AwardBadge = ({ type, place, link }: AwardBadgeProps) => {
  ...
  let enterTimeout = useRef<NodeJS.Timeout | null>(null);
  let leaveTimeout1 = useRef<NodeJS.Timeout | null>(null);
  let leaveTimeout2 = useRef<NodeJS.Timeout | null>(null);
  let leaveTimeout3 = useRef<NodeJS.Timeout | null>(null);
