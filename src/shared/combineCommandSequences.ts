import { CodinITMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of CodinITMessages.
 *
 * This function processes an array of CodinITMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of CodinITMessage objects to process.
 * @returns A new array of CodinITMessage objects with command sequences combined.
 *
 * @example
 * const messages: CodinITMessage[] = [
 ...
 */
export function combineCommandSequences(messages: CodinITMessage[]): CodinITMessage[] {
	const combinedCommands: CodinITMessage[] = []
