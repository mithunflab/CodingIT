...
/**
 * Combines API request start and finish messages in an array of CodinITMessages.
 *
 ...
 * @returns A new array of CodinITMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: CodinITMessage[]): CodinITMessage[] {
	const combinedApiRequests: CodinITMessage[] = []
