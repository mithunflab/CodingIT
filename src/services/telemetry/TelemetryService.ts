...
/**
 * PostHogClient handles telemetry event tracking for the CodinIT extension
...
class PostHogClient {
	...
	/**
	 * Records when CodinIT calls the task completion_result tool signifying that CodinIT is done with the task
