		...
		// this.clearTask()
		{
			...
			vscode.workspace.onDidChangeConfiguration(
				async (e) => {
					...
					if (e && e.affectsConfiguration("CodinIT.mcpMarketplace.enabled")) {
	...
	private async getHMRHtmlContent(webview: vscode.Webview): Promise<string> {
		...
		try {
			...
			vscode.window.showErrorMessage(
				"CodinIT: Local webview dev server is not running, HMR will not work. Please run 'npm run dev:webview' before launching the extension to enable HMR. Using bundled assets.",
			)
