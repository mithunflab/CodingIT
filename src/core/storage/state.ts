...
export async function getAllExtensionState(context: vscode.ExtensionContext) {
	const [
		...
		getSecret(context, "CodinITApiKey") as Promise<string | undefined>,
		...
		getGlobalState(context, "globalCodinITRulesToggles") as Promise<CodinITRulesToggles | undefined>,
...
export async function updateApiConfiguration(context: vscode.ExtensionContext, apiConfiguration: ApiConfiguration) {
	...
	await storeSecret(context, "CodinITApiKey", CodinITApiKey)
