...
Place the `.CodinITrules` file in your project's root directory:
...
-   **Memory Check** - _pacnpal_
    ...
    A fun way to verify CodinIT stays on track during complex tasks. Try "HO HO HO" for a festive twist!
