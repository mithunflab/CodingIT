# CodinIT Tools Reference Guide

## What Can CodinIT Do?

CodinIT is your AI assistant that can:
...
3. **Review Changes**
    - CodinIT will show diffs before making changes
...
For the most up-to-date implementation details, you can view the full source code in the [CodinIT repository](https://github.com/Cody/Cody/blob/main/src/core/task/index.ts).

CodinIT has access to the following tools for various tasks:
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that CodinIT can then access
    - Example: Create a weather API tool that CodinIT can use to fetch forecasts
...
-   [Join the Discord community](https://discord.gg/CodinIT)
-   Check the documentation
-   Provide feedback to improve CodinIT
