# CodinIT Mentions Feature Guide

## Overview

The mentions feature is a powerful capability that allows you to reference various resources in your conversations with CodinIT using the "@" symbol. This includes file contents, directory structures, webpage URLs, VSCode diagnostic information, terminal output, Git change status, and more - all easily incorporated into your conversations.

By using this feature, CodinIT can gain more accurate context and provide more relevant assistance for your tasks.
...
You can place mentions anywhere in your user messages, and CodinIT will automatically retrieve the referenced content.
...
In this example, CodinIT automatically retrieves the contents of Button.tsx and uses it to perform the analysis.
...
In this example, CodinIT retrieves a listing of the components directory and its contents.
...
In this example, CodinIT fetches the response from the GitHub API and analyzes the JSON.
...
In this example, CodinIT retrieves the current errors and warnings from your workspace and identifies high-priority issues.
...
In this example, CodinIT examines the latest terminal output and analyzes the error's cause.
...
In this example, CodinIT retrieves the list of changed files in the current Git working directory and identifies candidates for commit.
...
In this example, CodinIT retrieves information about the specified commit hash and analyzes the changes made in that commit.
...
Mastering the mentions feature makes your communication with CodinIT more efficient. By providing appropriate context, CodinIT can deliver more accurate assistance, significantly improving your development workflow.
